...
def train_agent(agent, env, brain_name, save_name = 'checkpoint', n_episodes=400, max_t=1001, scores_intervall= 100):
    ...
    for i_episode in range(1, n_episodes+1):
        ...
        scores.append(score)
        print('Episode {}\tAverage Score: {:.2f}\tScore: {:.2f}'.format(i_episode, np.mean(scores_deque), np.mean(score)), datetime.now(), end="\n")
